...
<div class="cont">
  ...
  out.println("<input type='hidden' name='cid' value='"+s1+"'>"); 
  %>
      ...
      <label class="star star-1" for="star-1-2"></label>
	   <textarea class="form-control" rows="5" id="comment" name="feedback" placeholder="Enter Your FeedBack About Complaint Response" required></textarea>
