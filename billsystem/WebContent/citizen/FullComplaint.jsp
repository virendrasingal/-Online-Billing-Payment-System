...
<body>
		<div class="center-container">
			...
			try
			{
				...
				String query="select * from complaintofficer where cid="+cid;
			...
			catch(Exception e)
			{
					...
					out.println("<label class='header'>OFFICER ID<span>:</span></label>");
					
					
							out.println("<input type='text' id='name' name='eid' readonly='true' required='' value="+s1+">");
									out.println("</div>");
									out.println("<div class='form-control'> ");
									out.println("<label class='header'>COMPLAINT ID<span>:</span></label>");
									
									
											out.println("<input type='text' id='name' name='cid' readonly='true' required='' value="+s2+">");
													out.println("</div>");
							out.println("<div class='form-control'> ");
									out.println("<label class='header'>UID OF CITIZEN<span>:</span></label>");
											out.println("<input type='text' id='name' name='name' readonly='true' required='' value="+s3+">");
													out.println("</div>");
				
															out.println("<div class='form-control'>");	
																	out.println("<label class='header'>EMAIL ADDRESS OF CITIZEN <span>:</span></label>");
																			out.println("<input type='email' id='email' name='email'  readonly='true' required='' value="+s4+">");
																					out.println("</div>");
				
																							out.println("<div class='form-control'>	");
																									out.println("<label class='header'>MOBILE NUMBER OF CITIZEN <span>:</span></label>");	
																											out.println("<input type='tel' id='usrtel' name='phone'  readonly='true' required='' value="+s5+">");
																													out.println("</div>	");
																													out.println("<div class='form-control'>");
																															out.println("<label class='enquiry'>COMPLAINT DISCRIPTION<span>:</span></label>");
																																	out.println("<textarea id='message' name='complaintd' readonly>"+s6+"</textarea>");
																																			out.println("<div class='clear'></div>");
																																					out.println("</div>");
																																					out.println("<div class='form-control'>");
																																							out.println("<label class='enquiry'>RESPONSE ABOUT COMPLAINT<span>:</span></label>");
																																									out.println("<textarea id='message' name='complaintr' minlength='40'  readonly>"+s7+"</textarea>");
																																											out.println("<div class='clear'></div>");
																																													out.println("</div>");
			%>
						...
						<div class="form-control w3ls-end">
							...
							<input type="submit" class="register" value="FEEDBACK">
							<div class="clear"></div>
						</div>	
					</form>
				</div>
